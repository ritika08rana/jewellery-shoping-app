	...
	<section class="form">
		...
		<div>
			<form action="userinfo.php" method="post" enctype="multipart/form-data">
				<div>
					<h2>Full Name</h2>
					<input type="text" name="user" autocomplete="off" placeholder="Avinash singh">

				</div>
				<div>
					<h2>Email Id</h2>
					<input type="text" name="email" autocomplete="off" placeholder="avi2001singh@gmail.com" id="emailid">

				</div>
				<div>
					<h2>Mobile No</h2>
					<input type="text" name="mobile" autocomplete="off" placeholder="8953086009">
				</div>
				<div>
					<h2>Address</h2>
					<input type="text" name="address" autocomplete="off" placeholder="kanpur">
				</div>
				<div>
					<h2>Product Code</h2>
